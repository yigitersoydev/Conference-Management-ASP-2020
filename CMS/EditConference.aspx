<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditConference.aspx.cs" Inherits="EditConference" %>
        ...
        <div class="content">
            <p>
                <strong>Conference Name:
                    <asp:TextBox ID="TextBox1" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
            <p>
                <strong>Topic:
                    <asp:TextBox ID="TextBox2" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
            <p>
                <strong>Start Date:
                    <asp:TextBox ID="TextBox3" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
            <p>
                <strong>End Date:
                    <asp:TextBox ID="TextBox4" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
            <p>
                <strong>Location:
                    <asp:TextBox ID="TextBox5" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
            <p>
                <strong>Price:
                    <asp:TextBox ID="TextBox6" runat="server" Width="300px"></asp:TextBox></strong>
            </p>
