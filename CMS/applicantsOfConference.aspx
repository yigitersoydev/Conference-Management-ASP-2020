<%@ Page Language="C#" AutoEventWireup="true" CodeFile="applicantsOfConference.aspx.cs" Inherits="applicantsOfConference" %>
...
<body>
    <form runat="server">
        ...
        <div>
            ...
            <asp:Repeater ID="rptr_Applicants" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td><%# Convert.ToDateTime(Eval("dateOfApplication")).ToString("dd/MM/yyyy")%></td>
                        <td><%#Eval("statusOfPayment")%> </td>
                        <td>
                            <a href="?userID=<%#Eval("userID")%>&conf=<%#Eval("conferenceID") %>" class="button">Conclude</a>
                            <%-- <asp:Button ID="btnConfirm" runat="server" Text="Confirm"/> <asp:Button ID="btnReject" runat="server" Text="Reject" /></td>--%>
                    </tr>
