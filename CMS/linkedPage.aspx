<%@ Page Language="C#" AutoEventWireup="true" CodeFile="linkedPage.aspx.cs" Inherits="linkedPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="ana">
               ...
               <asp:Panel ID="pnlSuccess" runat="server"><a href="Login.aspx">Click here to login.</a></asp:Panel>
                <asp:Panel ID="pnlFailure" runat="server"><a href="Register.aspx">Click here to register again.</a></asp:Panel>
</div>
        </center>
    </form>
</body>
