<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paperDetail.aspx.cs" Inherits="paperDetail" enableEventValidation="false" %>
...
<body>
    ...
    <div class="menudiv">
     ...
     <asp:Repeater ID="rptr_paperDetail" runat="server">
        <HeaderTemplate>
              <table>
        </HeaderTemplate>
        <ItemTemplate>
            ...
            <tr><td style="background-color:darkgrey"> <h2>Conference Subject</h2></td></tr>
             <tr><td><h4 >   <h4><%#Eval("conferenceSubject") %></h4></td></tr>
             <tr><td style="background-color:darkgrey"> <h2>Paper Title</h2></td></tr>
             <tr><td><h4 >   <h4><%#Eval("title") %></h4></td></tr>
             <tr><td style="background-color:darkgrey"> <h2>Paper Summary</h2></td></tr>
             <tr><td><h4 >   <h4><%#Eval("summary") %></h4></td></tr>

           
            <table class="tddTable">
                <tr class="tdd"><td class="tdd"><h4>Click the button below to view the document. </h4></td></tr>
                <tr class="tdd"> <td class="tdd"> <asp:Button ID="btnView" OnClick="btnView_Click" CssClass="btnConfirm" runat="server" Text="View"/> <%#Eval("filename") %> </td></tr>
                <tr class="tdd"> <td class="tdd">
                  <h3 style="font-family:Calibri; font-weight:bold">Please write a summary of your paper.</h3>
               
            <asp:TextBox ID="txtSummary" EnableViewState="true" TextMode="MultiLine" runat="server"  style="font-size:20px; border:1px solid; background-color:#FCF6FE;width:790px;height:200px;padding:3px;resize:none;"></asp:TextBox>
                </td></tr>
