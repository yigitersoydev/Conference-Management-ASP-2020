<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConferencesAsAdmin.aspx.cs" Inherits="ConferencesAsAdmin" %>
  ...
  <body>
    <form runat="server">
        ...
        <div>
            ...
            <asp:Repeater ID="rptr_ConferenceAsAdmin" runat="server">
                <HeaderTemplate>
