<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAnnouncement.aspx.cs" Inherits="AddAnnouncement" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="content">
                ...
                <p>
                    <strong>Subject:
                        <asp:TextBox ID="TextBox2" TextMode="MultiLine"  runat="server" style="resize:none;width:100%;height:200px;"></asp:TextBox></strong>
                </p>
              


                <asp:Button ID="Button1" runat="server" Text="Add" Height="30px" OnClick="Button1_Click" Width="120px" />
